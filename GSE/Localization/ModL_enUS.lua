...
L["To attempt automatic repair run: %s/gse fixsequence %d %s%s"] = true
L["Usage: /gse fixsequence <classid> <sequence name>"] = true
L["No sequence '%s' in class library %d."] = true
