...
local function scheduleGSEOverrideIconRepaint()
    ...
    if not GSE.After then return end
    GSE.After(0, function() repaintAllGSEOverrideIcons(false) end)
    GSE.After(0.1, function() repaintAllGSEOverrideIcons(false) end)
    GSE.After(0.25, function() repaintAllGSEOverrideIcons(false) end)
    GSE.After(0.5, function() repaintAllGSEOverrideIcons(false) end)
    GSE.After(1, function() repaintAllGSEOverrideIcons(false) end)
    GSE.After(2, function() repaintAllGSEOverrideIcons(false) end)
end
...
function GSE.CheckGUI()
    local loaded, reason = GSE.LoadAddOn("GSE_GUI")
    if not loaded then
