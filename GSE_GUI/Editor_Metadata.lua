...
local _HEADER_FIELD_SPACER = 8
local _SPEC_DROPDOWN_WIDTH = 180
local FORM_SIDE_PADDING = 24
local FIELD_COLUMN_EXTRA_WIDTH = 12
local _DEPENDENCY_COLUMN_GAP = 10
local _DEPENDENCY_COLUMN_MIN_WIDTH = 220
local CENTER_COLUMN_HALF_GAP = 5
local _DEPENDENCY_TOP_OFFSET = 0
local _METADATA_TWO_COLUMN_GAP = 34
local _METADATA_COMPACT_COLUMN_GAP = 10
local _METADATA_COMPACT_LABEL_WIDTH = 116
local _METADATA_MIN_DROPDOWN_WIDTH = 150
local _METADATA_CONTENT_WIDTH_RESERVE = 90
local METADATA_SECTION_GAP = 8
local METADATA_HEADER_HEIGHT = 24
local DEPENDENCY_WINDOW_HEIGHT = 118
local _DEPENDENCY_LABEL_HEIGHT = 24
...
local _METADATA_SCROLL_OFFSET = 120
...
local function metadataVersionAreaHeight(editframe)
    ...
    local _fixedHeight =
        ...
        4 +
        INLINE_ROW_HEIGHT +
        (METADATA_SECTION_GAP * 2) +
        DEPENDENCY_WINDOW_HEIGHT +
        METADATA_BOTTOM_PADDING +
        METADATA_LAYOUT_GAP_ALLOWANCE
