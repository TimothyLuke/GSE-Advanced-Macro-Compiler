...
function GSE.GUIViewerToolbar(container)
  ...
  recordwindowbutton:SetCallback('OnEnter', function () 
    GSE.CreateToolTip(L["Record Macro"], L["Record the spells and items you use into a new macro."], editframe) 
  end)
