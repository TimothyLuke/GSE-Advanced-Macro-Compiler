...
local _SKYRIDING_KEYBIND_PAGE_TITLE_HEIGHT = 34
local SKYRIDING_KEYBIND_DIVIDER_HEIGHT = 1
local SKYRIDING_KEYBIND_LIST_GAP = 2
local _SKYRIDING_KEYBIND_LIST_PAD_TOP = 4
local _SKYRIDING_KEYBIND_LIST_PAD_BOTTOM = 10
        ...
        for i = 1, SKYRIDING_KEYBIND_ROW_COUNT do
            ...
            button:SetCallback("OnClick", function(widget, mouseButton)
                if mouseButton == "RightButton" then
                    ...
                    if GSE.After then GSE.After(0, doCancel) else doCancel() end
                else
