...
function addExtras(done) {
  ...
  return fs.cp(srcDir, destDir, { recursive: true }, done);
}
...
async.waterfall(
  [
    ...
    async.apply(updateToc, "GSE", "GSE_TBC"),
    async.apply(updateToc, "GSE", "GSE_Vanilla"),
    async.apply(updateToc, "GSE", "GSE_Wrath"),
    async.apply(updateToc, "GSE_GUI", "GSE_GUI"),
    async.apply(updateToc, "GSE_GUI", "GSE_GUI_TBC"),
    async.apply(updateToc, "GSE_GUI", "GSE_GUI_Vanilla"),
    async.apply(updateToc, "GSE_GUI", "GSE_GUI_Wrath"),
